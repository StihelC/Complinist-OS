 ...
 * Smart Custom Edge
 *
 * A custom edge that routes around nodes using obstacle avoidance.
...
const SmartCustomEdgeComponent = ({
  id,
  source,
  target,
  ...
  // Use shared hook for path calculation
...
export const SmartCustomEdge = memo(SmartCustomEdgeComponent);
SmartCustomEdge.displayName = 'SmartCustomEdge';
