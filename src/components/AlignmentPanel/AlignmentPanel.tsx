...
import { ChevronRight, ChevronLeft, Grid3x3, ZoomIn, ZoomOut, Maximize2, Type, ArrowUp, ArrowDown } from 'lucide-react';
...
export const AlignmentPanel = () => {
  ...
  if (isCollapsed) {
    return (
      <div className="absolute left-4 top-[128px] z-20">
        <Button
  ...
  return (
    <div className="absolute left-4 top-[128px] z-40 w-80">
